        ...
        with sqlalchemy.orm.Session(db_engine) as session:
            ...
            while True:
                ...
                try:
                    ...
                    #t2 = time.time()
                    #logger.info('construct_output_path used {} s'.format(t2-t1))
                    ...
                    #t3 = time.time()
                    #logger.info('construct_output_tiers used {} s'.format(t3-t2))
                    export_textgrid(
                        data, output_path, duration, self.export_frame_shift, self.output_format
                    )
                    #t4 = time.time()
                    #logger.info('export_textgrid used {} s'.format(t4-t3))
